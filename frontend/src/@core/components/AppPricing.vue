<script setup>
import safeBoxWithGoldenCoin from '@/assets/images/misc/3d-safe-box-with-golden-dollar-coins.png'
import spaceRocket from '@/assets/images/misc/3d-space-rocket-with-smoke.png'
import dollarCoinPiggyBank from '@/assets/images/misc/dollar-coins-flying-pink-piggy-bank.png'
