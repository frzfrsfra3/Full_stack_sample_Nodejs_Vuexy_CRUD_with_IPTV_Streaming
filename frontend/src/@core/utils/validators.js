...
export const passwordValidator = password => {
  ...
  return (
    ...
    validPassword ||
        t('Field must contain at least one uppercase, lowercase, special character and digit with min 8 chars'))
}

//  Confirm Password Validator
export const confirmedValidator = (value, target) => value === target || t('The Confirm Password field confirmation does not match')
...
export const alphaDashValidator = value => {
  ...
  return /^[0-9A-Z_-]*$/i.test(valueAsString) || t('All Character are not valid')
}
